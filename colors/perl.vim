...
if exists("syntax_on")
  ...
  highlight StatusLine     gui=bold guibg=DarkGrey   guifg=Magenta
  highlight StatusLineNC            guibg=DarkGrey   guifg=Magenta

  highlight Comment    term=bold      ctermfg=Red                  guifg=#f1dd30
  highlight Constant   term=underline ctermfg=White                      guifg=#ffa000
  highlight Number     term=underline ctermfg=Magenta                     guifg=#f1dd30
  highlight Identifier term=underline ctermfg=White                       guifg=#40ffff
  highlight Statement  term=bold      ctermfg=Yellow           gui=bold  guifg=#f1dd30
  ...
  highlight Special    term=bold      ctermfg=Yellow                    guifg=Magenta
  highlight Ignore                    ctermfg=black                      guifg=bg
  highlight Error                     ctermfg=White      ctermbg=Magenta     guifg=White    guibg=Magenta
  highlight Todo                      ctermfg=Magenta       ctermbg=Magenta  guifg=Magenta     guibg=Magenta

  " Change the highlight of search matches (for use with :set hls).
  highlight Search                    ctermfg=Black      ctermbg=Magenta  guifg=Black    guibg=Magenta  
  ...
  highlight Float                     ctermfg=Magenta                       guifg=#88AAEE
  highlight Exception                 ctermfg=Magenta        ctermbg=White   guifg=Magenta      guibg=White
  highlight Typedef                   ctermfg=White      ctermbg=Magenta    gui=bold       guifg=White guibg=Magenta
